...
public class Enemy_Base : WizSimBehavior {
	...
	{
		gameObject.transform.rotation = Quaternion.RotateTowards(gameObject.transform.rotation, player.transform.rotation, rotspeed);
	}
	public void FacePlayer(float speed)
	{
		gameObject.transform.rotation = Quaternion.RotateTowards(gameObject.transform.rotation, player.transform.rotation, speed);
	}
}
